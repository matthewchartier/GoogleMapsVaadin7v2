...
public class GoogleMapConnector extends AbstractComponentConnector implements
        MarkerClickListener, PolylineClickListener, MapMoveListener, MapClickListener,
    ...
    @Override
    public void polylineClicked(GoogleMapPolyline clickedPolyline) { polylineClickedRpc.polylineClicked(clickedPolyline.getId()); }
