...
//        style1.setElementType(null);
//        style1.setFeatureType(null);

        MapTypeStyler[] array = { MapTypeStyler.newSaturationStyler(-50), MapTypeStyler.newVisibilityStyler("on") };
        style1.setStylers(array);

        mapOptions.setMapTypeStyles(new MapTypeStyle[] { style1 });
    ...
    public void setPolylineClickListener(PolylineClickListener listener) { polylineClickListener = listener; }
    ...
    public void setPolylineOverlays(Collection<GoogleMapPolyline> polylineOverlays) {
